  ...
  def createStream[T: ClassTag](
    ...
    ssc.withNamedScope("kinesis stream") {
      new KinesisInputDStream[T](ssc, streamName, endpointUrl, validateRegion(regionName),
        ...
        cleanedHandler, DefaultCredentials, None, None, None, None, None)
    }
  }
  ...
  def createStream[T: ClassTag](
    ...
    ssc.withNamedScope("kinesis stream") {
      ...
      new KinesisInputDStream[T](ssc, streamName, endpointUrl, validateRegion(regionName),
        KinesisInitialPositions.fromKinesisInitialPosition(initialPositionInStream),
        kinesisAppName, checkpointInterval, storageLevel,
        cleanedHandler, kinesisCredsProvider, None, None, None, None, None)
    }
  }
  ...
  def createStream(
    ...
    ssc.withNamedScope("kinesis stream") {
      new KinesisInputDStream[Array[Byte]](ssc, streamName, endpointUrl, validateRegion(regionName),
        KinesisInitialPositions.fromKinesisInitialPosition(initialPositionInStream),
        kinesisAppName, checkpointInterval, storageLevel,
        KinesisInputDStream.defaultMessageHandler, DefaultCredentials, None, None, None, None, None)
    }
  }
  ...
  def createStream(
    ...
    ssc.withNamedScope("kinesis stream") {
      ...
      new KinesisInputDStream[Array[Byte]](ssc, streamName, endpointUrl, validateRegion(regionName),
        KinesisInitialPositions.fromKinesisInitialPosition(initialPositionInStream),
        kinesisAppName, checkpointInterval, storageLevel,
        KinesisInputDStream.defaultMessageHandler, kinesisCredsProvider, None, None, None, None, None)
    }
  }
